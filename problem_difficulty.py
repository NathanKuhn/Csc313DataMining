...
def get_difficulty_stats():
    ...
    avg_attempts = {
        k: total_attempts_per_problem[k] / total_students_per_problem[k]
        for k in total_students_per_problem
    }
    avg_successes = {
        k: total_successes_per_problem[k] / total_students_per_problem[k]
        for k in total_students_per_problem
    }
